...
export const analyticsEvents = {
    ...
    recipeTagsBulkRemoved: 'recipe_tags_bulk_removed',
    recipeAutotagged: 'recipe_autotagged',
    recipeFavoriteUpdated: 'recipe_favorite_updated',
    ...
    recipeCollectionImportStarted: 'recipe_collection_import_started',
    recipeCollectionImportFinished: 'recipe_collection_import_finished',
    recipeCollectionImportRetried: 'recipe_collection_import_retried',
