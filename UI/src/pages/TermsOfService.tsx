                    ...
                    <CardContent className='prose prose-sm max-w-none space-y-6'>
                        <section>
                            ...
                            <p className='text-muted-foreground'>
                                By accessing and using MyApp, you accept and agree to be bound by the terms and
                        ...
                        <section>
                            ...
                            <p className='text-muted-foreground'>
                                Permission is granted to temporarily use MyApp for personal, non-commercial transitory
                        ...
                        <section>
                            ...
                            <p className='text-muted-foreground'>
                                We implement appropriate security measures to protect your financial data. However, no
