...
internal static class MealPrepMcpToolsRegistration
{
    ...
    private static void ApplyToolBehaviorHints(McpServerToolCreateOptions options, string methodName) {
        var (readOnly, destructive, idempotent, openWorld) = methodName switch {
            ...
            nameof(MealPrepMcpTools.RenameRecipe) => (false, false, true, false),
            nameof(MealPrepMcpTools.SetRecipeTags) => (false, false, true, false),
            nameof(MealPrepMcpTools.ArchiveRecipe) => (false, false, true, false),
            nameof(MealPrepMcpTools.DeleteRecipe) => (false, true, false, false),
            nameof(MealPrepMcpTools.ImportRecipe) => (false, false, false, true),
            nameof(MealPrepMcpTools.ListNextMeals) => (true, false, true, false),
            nameof(MealPrepMcpTools.PutNextMeal) => (false, true, false, false),
            nameof(MealPrepMcpTools.DeleteNextMeal) => (false, true, false, false),
