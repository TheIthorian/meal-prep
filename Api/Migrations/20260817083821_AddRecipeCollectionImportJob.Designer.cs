...
namespace Api.Migrations
{
    ...
    [Migration("20260817083821_AddRecipeCollectionImportJob")]
    partial class AddRecipeCollectionImportJob
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Api.Models.RecipeCollectionImportJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("SourceCollectionName")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("character varying(255)");
                    ...
                    b.Property<Guid?>("TargetRecipeCollectionId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("WorkspaceId", "ShareToken");

                    b.HasIndex("WorkspaceId", "Status");

                    b.ToTable("RecipeCollectionImportJobs");
                });

            modelBuilder.Entity("Api.Models.RecipeCollectionImportJobItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("ImportedRecipeId")
                        .HasColumnType("uuid");

                    b.Property<Guid>("RecipeCollectionImportJobId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("RecipeCollectionImportJobId", "Status");

                    b.ToTable("RecipeCollectionImportJobItems");
                });
            ...
            modelBuilder.Entity("Api.Models.RecipeCollectionImportJob", b =>
                {
                    b.HasOne("Api.Models.AppUser", "StartedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Api.Models.RecipeCollectionImportJobItem", b =>
                {
                    b.HasOne("Api.Models.RecipeCollectionImportJob", "RecipeCollectionImportJob")
                        .WithMany("Items")
                        .HasForeignKey("RecipeCollectionImportJobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RecipeCollectionImportJob");
                });
